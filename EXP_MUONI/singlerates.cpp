...
void singlerates()
{
    double V1[]         = {1889., 1949., 2000.,  2049.,  2098.,  2151.,  2201.,  2248.};    //2201
    double count1[]     = {1440., 5816., 15406., 30816., 45665., 43004., 64865., 135611.};

    double V2[]         = {1907., 1948., 2000.,  2050.,  2100.,  2150.,  2200.,  2256.};    //2200
    double count2[]     = {10.,   34.,   94.,    259.,   1288.,  2350.,  3803.,  5845.};

    double V3[]         = {1911., 1954., 2004.,  2050.,  2100.,  2151.,  2204.,  2248.};    //2204
    double count3[]     = {101.,  373.,  854.,   1844.,  3545.,  3515.,  5298.,  7060.};

    double VG[]         = {1298., 1354., 1398.,  1448.,  1501.,  1552.,  1599.,  1652.};    //1599
    double countG[]     = {568.,  1901., 3410.,  4955.,  6403.,  7518.,  27600., 161087.};

    double T[]          = {300.,  300.,  300.,   300.,   300.,   200.,   200.,   200.};  //200
